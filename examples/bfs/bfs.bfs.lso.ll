...
define dso_local void @bfs(i32* noalias nocapture readonly %rows, i32* noalias nocapture readonly %cols, i32 %count, i32* noalias nocapture %queue, i32* noalias nocapture %visited, i32* noalias nocapture %walk) local_unnamed_addr #0 {
entry:
  br label %while.cond
...
while.body:                                       ; preds = %while.cond
  ...
  %0 = call i32 (i32*, ...) @cgra_load32(i32* %arrayidx, i32 %lso.alloc1.0)
...
for.body:                                         ; preds = %for.cond
  ...
  %4 = call i32 (i32*, ...) @cgra_load32(i32* %arrayidx7, i32 %lso.alloc3.1)
...
if.then:                                          ; preds = %for.body
  ...
  %6 = call i32 (i32, i32*, ...) @cgra_store32(i32 1, i32* %arrayidx7)
  br label %if.end

if.end:                                           ; preds = %if.then, %for.body
  %lso.alloc1.2 = phi i32 [ %5, %if.then ], [ %lso.alloc1.1, %for.body ]
  %lso.alloc3.2 = phi i32 [ %6, %if.then ], [ %lso.alloc3.1, %for.body ]
