...
define dso_local void @nn_relu(i32* nocapture readonly %src, i32* nocapture %dest, i32 %size) local_unnamed_addr #0 {
entry:
...
for.body:                                         ; preds = %for.cond
  ...
  %3 = call i32 (i32, i32*, ...) @cgra_store32(i32 %spec.store.select, i32* %dest_ptr.0)
